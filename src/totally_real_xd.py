...
if __name__ == "__main__":
    ...
    for dict in data_dict:
        ...
        # {'gas': 612982.4099782794, 'humidity': 42.979, 'air_quality_score': 91.05900589211731, 'temperature': 25.52,
        # 'pressure': 977.27, 'altitude': 304.108018388582}

        print('gas:', gas, 'Ohms | humidity:', humidity, '% | air quality:', air_quality_score, '% | Temp::',
              temperature, '°C | Pressure:', pressure, 'hPa | altitude:', altitude, 'm')
        time.sleep(1)
